...
def openvolunWindow():
    ...
    reg = Button(volunWindow, text="Registration Form", height=3, width=25,command=openregistrationWindow)  # a button widget which will open a new window on button click
...
def openloginWindow():
    ...
    info = Button(loginWindow, text="Covid Information", height=3, width=25,command=opencovidInformation)  # a button widget which will open a new window on button click
    info.place(x=800, y=300)

    res = Button(loginWindow, text="Covid Resources", height=3, width=25,command=opencovidResources)  # a button widget which will open a new window on button click
...
def opencovidResources():
      ...
      c11 = Button(covidResources, text="Centre Details", height=3, width=25,command=opencovidcentreDetails)  # a button widget which will open a new window on button click
      c11.place(x=550, y=50)

      c22 = Button(covidResources, text="Bed Centre", height=3, width=25,command=openBedsdetails)  # a button widget which will open a new window on button click
      c22.place(x=550, y=150)

      c33 = Button(covidResources, text="Testing Labs", height=3, width=25,command=opentestingLabs)  # a button widget which will open a new window on button click
      c33.place(x=550, y=250)

      c44 = Button(covidResources, text="Plasma", height=3, width=25,command=openPlasma)  # a button widget which will open a new window on button click
      c44.place(x=550, y=350)

      c55 = Button(covidResources, text="Injections", height=3, width=25,command=openInjections)  # a button widget which will open a new window on button click
      c55.place(x=550, y=450)

      c66 = Button(covidResources, text="Vaccine", height=3, width=25,command=openVaccine)  # a button widget which will open a new window on button click
...
def opencovidcentreDetails():
    ...
    ra4 = Radiobutton(covidcentreDetails, text="Plasma Donation Centre", variable=var, value=4) #, value=3, command=viewSelected)
    ra4.place(x=700, y=340)
    ra5 = Radiobutton(covidcentreDetails, text="Injection Distributor", variable=var, value=5) #, value=3, command=viewSelected)
    ra5.place(x=700, y=370)
    ra6 = Radiobutton(covidcentreDetails, text="Vaccination Centre", variable=var, value=6) #, value=3, command=viewSelected)
...
def openPlasma():
    ...
    var = IntVar()
    ra1 = Radiobutton(Plasma, text="A+", variable=var, value=1)  # , command=viewSelected)
    ra1.place(x=700, y=150)
    ra2 = Radiobutton(Plasma, text="A-", variable=var, value=2)  # , command=viewSelected)
    ra2.place(x=700, y=180)
    ra3 = Radiobutton(Plasma, text="B+", variable=var, value=3)  # , command=viewSelected)
    ra3.place(x=700, y=210)
    ra4 = Radiobutton(Plasma, text="B-", variable=var,
                      value=4)  # , value=3, command=viewSelected)
    ra4.place(x=700, y=240)
    ra5 = Radiobutton(Plasma, text="O+", variable=var,
                      value=5)  # , value=3, command=viewSelected)
    ra5.place(x=700, y=270)
    ra6 = Radiobutton(Plasma, text="O-", variable=var,
                      value=6)  # , value=3, command=viewSelected)
    ra6.place(x=700, y=300)
    ra7 = Radiobutton(Plasma, text="AB+", variable=var,
                      value=5)  # , value=3, command=viewSelected)
    ra7.place(x=700, y=330)
    ra8 = Radiobutton(Plasma, text="AB-", variable=var,
                      value=6)  # , value=3, command=viewSelected)
...
def openregistrationWindow():
        ...
        middle_entry = Entry(registrationWindow, textvariable=username)
        ...
        first_entry = Entry(registrationWindow, textvariable=username)
        first_entry.place(x=270, y=150)

volunWindow = Button(root, text="Volunteers", height= 3, width=25 ,command=openvolunWindow) # a button widget which will open a new window on button click
...
viewbtn = Button(root, text="Viewers", height= 3, width=25, command=openviewWindow) # a button widget which will open a new window on button click
